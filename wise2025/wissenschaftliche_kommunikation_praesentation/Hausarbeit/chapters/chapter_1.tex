...
Das Framework Tauri v2 verspricht durch die Trennung von Frontend (Web-Technologien) und Backend (Rust) sowie die Nutzung der im Betriebssystem vorhandenen Webview (WebView2 unter Windows \cite{webview2Docs}) eine signifikante Reduktion der Artefaktgröße und des Ressourcenverbrauchs.
\begin{figure}[htbp]
    \centering
