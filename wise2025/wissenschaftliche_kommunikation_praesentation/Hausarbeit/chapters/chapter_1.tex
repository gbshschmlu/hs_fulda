...
Die technische Verteilung dieser Software unterliegt verschiedenen Restriktionen:
\begin{enumerate}
    \item \textbf{Unbekannte Zielumgebungen:} Die Systemausstattung der Lieferanten ist nicht bekannt.
    Teilweise werden ältere Systeme (Windows 10) mit begrenzten Ressourcen verwendet.
    \item \textbf{Verteilung und Bandbreite:} Bei Verteilung über E-Mail oder in Regionen mit begrenzter Internetbandbreite ist die Dateigröße kritisch.
    \item \textbf{Installationsberechtigungen:} Viele Lieferanten haben keine Administratorrechte.
    Die Installation muss im \glqq User Mode\grqq{} durchführbar sein und unternehmensspezifische Anpassungen (Lizenztexte, Branding) unterstützen.
\end{enumerate}
...
Tauri v2 nutzt einen Architekturansatz, der Frontend (Web-Technologien) und Backend (Rust) trennt sowie die systemeigene Webview (WebView2 unter Windows \cite{webview2Docs}) einsetzt. Dieser Ansatz lässt eine Reduktion von Artefaktgröße und Ressourcenverbrauch erwarten.
\begin{figure}[htbp]
    \centering
